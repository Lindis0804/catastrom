...
abstract class EnvVariable {
  static String clientCustomerHost =
      _env('CLIENT_CUSTOMER_HOST') ?? 'http://localhost:8082';
  static String coreLocationHost =
      _env('CORE_LOCATION_HOST') ?? 'http://localhost:8082';
  static String defaultCover = _env('DEFAULT_COVER') ??
  ...
  static String defaultAvatar = _env('DEFAULT_AVATAR') ??
